namespace threadRace
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Thread.CurrentThread.Name = "Ichigo Kurosaki";
                for (int i = 0; i < 100; i++)
                {
            ...
            {
                Thread.CurrentThread.Name = "Killua Zoldyck";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            {
                Thread.CurrentThread.Name = "Saitama";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            {
                Thread.CurrentThread.Name = "Minato Namikaze";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
